...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getMove(category, obscuredPhrase, guessed):
        return category.getPossibleLetters(guessed)
    ...
    class WOFPlayer:
        ...
        def addPrize(self, prizes, prize):
    ...
    human_players = [WOFHumanPlayer(input('Enter the name for human player #{}'.format(i + 1))) for i in
                     range(num_human)]
